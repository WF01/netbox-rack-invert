"""
Search indexes for Netbox Rack Inverter.
...
class Rack_InverterIndex(SearchIndex):
    """
    Search index for Rack_Inverter model.

    This enables Rack_Inverter objects to appear in NetBox's global
    search results.
    """
